//! Accept mathematically integral JSON number tokens for integer-valued tool arguments.
//!
//! Some backends emit `180000.0` for JSON Schema `number`. Serde `i64`/`u64`/`usize`/`i32`
