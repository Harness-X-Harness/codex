...
///   Completed `custom_tool_call` items are exempt (hosted / no client output).
///   Grok replay omits `status`; that form is treated as hosted. Incomplete
///   statuses still require a matching output.
