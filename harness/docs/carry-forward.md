...
`.github/workflows/harness.yml` is the deterministic acceptance boundary.
Shared stock seams require stock controls. Product-specific tests must not
silently redefine stock behavior.
