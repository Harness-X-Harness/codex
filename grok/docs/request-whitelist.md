...
| Anchor | Value |
|--------|-------|
| Stock Codex | `openai/codex rust-v0.156.1@b412ff32c417f855c2b2d1581b77058eed87c84b` |
| Validated Grok source | `grok/main@82d62fe575707988d23bf629017a26c357714e58` |
| Candidate/version line | `grok/rust-v0.156.1@b412ff32c417f855c2b2d1581b77058eed87c84b` |
| Review work | `carry/grok-rust-v0.156.1`, targeting `grok/rust-v0.156.1` |
...
PR to `grok/rust-v0.156.1` runs Cargo on GitHub's native merge ref. A later
push to the version line produces the complete Linux x64 musl and macOS ARM64
distribution artifacts and runs Live on the Linux artifact. Delivery follows
[`release.md`](./release.md). A whitelist commit is a proof input and needs its
own GREEN PR/push proof; a docs-only commit does not.
