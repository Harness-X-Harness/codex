...
```sh
curl -fsSL https://github.com/Harness-X-Harness/codex/releases/download/grokex-v0.148.0-alpha.5/install-grokex.sh | sh
```

On Windows PowerShell:

```powershell
irm https://github.com/Harness-X-Harness/codex/releases/download/grokex-v0.148.0-alpha.5/install-grokex.ps1 | iex
```
